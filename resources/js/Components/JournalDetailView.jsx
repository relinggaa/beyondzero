...
export default function JournalDetailView({ journal, onClose, onEdit, onDelete }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-[9999] p-4" onClick={(e) => e.target === e.currentTarget && onClose()}>
            ...
            {/* Combined Container - Book Only */}
            <div className="flex items-center justify-center max-w-[1600px] w-full h-[calc(100vh-120px)] mx-auto mt-20">
                {/* Book Container */}
                <div className="w-full flex items-center justify-center">
                    <div className="relative w-full h-[550px] flex items-center justify-center max-w-[1400px]">
                        ...
                        {/* Book Shelf/Stand */}
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-[550px] h-[750px] bg-gradient-to-b from-slate-800/20 via-slate-900/10 to-slate-800/20 rounded-3xl blur-3xl opacity-50"></div>
                        </div>
